function [Jacs, Transformations] = getHumanExoJacobians(model,Q_act,Inertias,Lengths,XoR_or_H3_flag,grav_comp_flag,i)
...
%% Right Human Leg
hip_flexion = makehgtform('zrotate', (Q_act.hip_flexion_r(i)), 'xrotate', pi/2);
hip_adduction =  makehgtform('zrotate', (Q_act.hip_adduction_r(i)-pi/2), 'xrotate', -pi/2); %hip adduction
hip_rotation_hk_transf = makehgtform('zrotate', (Q_act.hip_rotation_r(i)-pi/2),'translate', [0 0 -Lengths.human.femur], 'xrotate', pi/2); %hip rotation
...
hip_rotation_trans_COM_h = makehgtform('zrotate', Q_act.hip_rotation_r(i), 'translate', [-Inertias.human.COMs.femur_r(3) -Inertias.human.COMs.femur_r(1) Inertias.human.COMs.femur_r(2)]);
T0_COM_h = T02*hip_rotation_trans_COM_h;
Transformations.human.right.hip_to_COM_femur=T0_COM_h;

T03 = T02*hip_rotation_hk_transf;
Transformations.human.right.hip_to_knee = T03;

rotz_k_COM_k = makehgtform('zrotate', (Q_act.knee_angle_r(i)-(pi/2)), 'translate', [-Inertias.human.COMs.tibia_r(2) Inertias.human.COMs.tibia_r(1) Inertias.human.COMs.tibia_r(3)]);
T0_COM_k = T03*rotz_k_COM_k;
Transformations.human.right.hip_to_COM_tibia=T0_COM_k;

rotz_k_trans_ka = makehgtform('zrotate', (Q_act.knee_angle_r(i)-pi/2),'translate', [Lengths.human.tibia_r,0,0]);
T04 = T03*rotz_k_trans_ka;
Transformations.human.right.hip_to_talus = T04;

rotz_a_toes = makehgtform('zrotate', Q_act.ankle_angle_r(i),'translate', [-Inertias.human.COMs.foot_r(2) Lengths.human.foot_r Inertias.human.COMs.foot_r(3)]);
T0_toes = T04 * rotz_a_toes;
Transformations.human.right.hip_to_toes = T0_toes;

rotz_a_COM_a = makehgtform('zrotate', Q_act.ankle_angle_r(i),'translate', [-Inertias.human.COMs.foot_r(2) Inertias.human.COMs.foot_r(1) Inertias.human.COMs.foot_r(3)]);
T0_COM_a = T04 * rotz_a_COM_a;
Transformations.human.right.hip_to_COM_foot=T0_COM_a;


if isequal(grav_comp_flag,'ON')
    ...
    Jo2 = Z1;
    Jo_COM_h = Z2;
    Jacs.human.right.hip_to_COM_femur = [Jp1_COM_h Jp2_COM_h JpEE_COM_h; Jo1 Jo2 Jo_COM_h];
    ...
    Jo3 = Z2;
    Jo_COM_k = Z3;
    Jacs.human.right.hip_to_COM_tibia = [Jp1_COM_k Jp2_COM_k Jp3_COM_k JpEE_COM_k; Jo1 Jo2 Jo3 Jo_COM_k];
    ...
    Jacs.human.right.hip_to_COM_talus=[Jp1_talus Jp2_talus Jp3_talus Jp4_talus;Jo1 Jo2 Jo3 Jo4];
    ...
    Jo_COM_a = Z4;
    Jacs.human.right.hip_to_COM_foot = [Jp1_COM_a Jp2_COM_a Jp3_COM_a Jp4_COM_a JpEE_COM_a; Jo1 Jo2 Jo3 Jo4 Jo_COM_a];
else
    Jacs=[];
end
% rotz_a_trans_a_toes = makehgtform('zrotate', Q_act.ankle_angle_r(i),'translate', [Lengths.human.foot_r,0,0]);
% Transformations.human.right.hip_to_toes = T04 * rotz_a_trans_a_toes;

%% Left Human Leg
hip_flexion = makehgtform('zrotate', (Q_act.hip_flexion_l(i)), 'xrotate', pi/2);
hip_adduction = makehgtform('zrotate', (Q_act.hip_adduction_l(i)-pi/2), 'xrotate', -pi/2); %hip adduction
hip_rotation_hk_transf = makehgtform('zrotate', (Q_act.hip_rotation_l(i)-pi/2),'translate', [0 0 -Lengths.human.femur], 'xrotate', pi/2); %hip rotation

T01 = hip_flexion;
T02 = T01*hip_adduction;

hip_rotation_trans_COM_h = makehgtform('zrotate', Q_act.hip_rotation_l(i), 'translate', [-Inertias.human.COMs.femur_l(3) -Inertias.human.COMs.femur_l(1) Inertias.human.COMs.femur_l(2)]);
T0_COM_h = T02*hip_rotation_trans_COM_h;
Transformations.human.left.hip_to_COM_femur=T0_COM_h;

T03 = T02*hip_rotation_hk_transf;
Transformations.human.left.hip_to_knee = T03;

rotz_k_COM_k = makehgtform('zrotate', (Q_act.knee_angle_l(i)-(pi/2)), 'translate', [-Inertias.human.COMs.tibia_l(2) Inertias.human.COMs.tibia_l(1) Inertias.human.COMs.tibia_l(3)]);
T0_COM_k = T03*rotz_k_COM_k;
Transformations.human.left.hip_to_COM_tibia=T0_COM_k;

rotz_k_trans_ka = makehgtform('zrotate', (Q_act.knee_angle_l(i)-pi/2),'translate', [Lengths.human.tibia_l,0,0]);
T04 = T03*rotz_k_trans_ka;
Transformations.human.left.hip_to_talus = T04;

rotz_a_toes = makehgtform('zrotate', Q_act.ankle_angle_l(i),'translate', [-Inertias.human.COMs.foot_l(2) Lengths.human.foot_l Inertias.human.COMs.foot_l(3)]);
T0_toes = T04 * rotz_a_toes;
Transformations.human.left.hip_to_toes = T0_toes;

rotz_a_COM_a = makehgtform('zrotate', Q_act.ankle_angle_l(i),'translate', [-Inertias.human.COMs.foot_l(2) Inertias.human.COMs.foot_l(1) Inertias.human.COMs.foot_l(3)]);
T0_COM_a = T04 * rotz_a_COM_a;
Transformations.human.left.hip_to_COM_foot=T0_COM_a;
...
if isequal(grav_comp_flag,'ON')
    ...
    Jo2 = Z1;
    Jo_COM_h = Z2;
    Jacs.human.left.hip_to_COM_femur = [Jp1_COM_h Jp2_COM_h JpEE_COM_h; Jo1 Jo2 Jo_COM_h];
    ...
    Jo3 = Z2;
    Jo_COM_k = Z3;
    Jacs.human.left.hip_to_COM_tibia = [Jp1_COM_k Jp2_COM_k Jp3_COM_k JpEE_COM_k; Jo1 Jo2 Jo3 Jo_COM_k];
    ...
    Jp3_talus =cross(Z2,P4-P2);
    Jp4_talus =cross(Z3,P4-P3);
    Jacs.human.left.hip_to_COM_talus=[Jp1_talus Jp2_talus Jp3_talus Jp4_talus;Jo1 Jo2 Jo3 Jo4];
    ...
    Jo4 = Z3;
    Jo_COM_a = Z4;
    Jacs.human.left.hip_to_COM_foot = [Jp1_COM_a Jp2_COM_a Jp3_COM_a Jp4_COM_a JpEE_COM_a; Jo1 Jo2 Jo3 Jo4 Jo_COM_a];
else
    Jacs=[];
end
% rotz_a_trans_a_toes = makehgtform('zrotate', Q_act.ankle_angle_l(i),'translate', [Lengths.human.foot_l,0,0]);
% Transformations.human.left.hip_to_toes = T04 * rotz_a_trans_a_toes;

%% Right Exo Leg
hip_flexion = makehgtform('zrotate', (Q_act.(['H3_hip_flexion_r'])(i)), 'xrotate', pi/2); %creates a 4x4 transform matrix which has rotational and translational commands Q is theta of the joints, act is the actial ref is the desired
hip_adduction = makehgtform('zrotate', (Q_act.(['H3_hip_adduction_r'])(i)-pi/2), 'xrotate', -pi/2); %hip adduction
hip_rotation_hk_transf = makehgtform('zrotate', (Q_act.(['H3_hip_rotation_r'])(i)-pi/2),'translate', [0 0 -Lengths.exo.thigh_r], 'xrotate', pi/2); %hip rotation
...
hip_rotation_trans_COM_h = makehgtform('zrotate', Q_act.(['H3_hip_rotation_r'])(i), 'translate', [-Inertias.exo.COMs.(['H3_thigh_r'])(3)-hip_motor_trans_thigh(3) -Inertias.exo.COMs.(['H3_thigh_r'])(1)-hip_motor_trans_thigh(1) Inertias.exo.COMs.(['H3_thigh_r'])(2)+hip_motor_trans_thigh(2)]); %accesses the gravity centres of the joint
...
hip_rotation_trans_COM_hip_motor = makehgtform('zrotate', Q_act.(['H3_hip_rotation_r'])(i), 'translate', [-Inertias.exo.COMs.(['hip_motor_r'])(3) -Inertias.exo.COMs.(['hip_motor_r'])(1) Inertias.exo.COMs.(['hip_motor_r'])(2)]);% centre of mass of hip
...
rotz_a_toes = makehgtform('zrotate', Q_act.(['H3_ankle_angle_r'])(i),'translate', [-Inertias.exo.COMs.(['H3_foot_r'])(2) Lengths.exo.foot_r Inertias.exo.COMs.(['H3_foot_r'])(3)]);
T0_toes = T04 * rotz_a_toes;
...
rotz_a_COM_a = makehgtform('zrotate', Q_act.(['H3_ankle_angle_r'])(i),'translate', [-Inertias.exo.COMs.(['H3_foot_r'])(2)-ankle_motor_trans_foot(2) Inertias.exo.COMs.(['H3_foot_r'])(1)+ankle_motor_trans_foot(1) Inertias.exo.COMs.(['H3_foot_r'])(3)+ankle_motor_trans_foot(3)]);
T0_COM_a = T04 * rotz_a_COM_a;
...
hip_rotation_trans_COM_sup_thigh_cuff = makehgtform('zrotate', Q_act.(['H3_hip_rotation_r'])(i), 'translate', [-hip_motor_COM_sup_thigh_cuff_offset(3) -hip_motor_COM_sup_thigh_cuff_offset(1) hip_motor_COM_sup_thigh_cuff_offset(2)]);
...
knee_trans_COM_knee_motor = makehgtform('zrotate', (Q_act.(['H3_knee_angle_r'])(i)-pi/2),'translate', [-Inertias.exo.COMs.knee_motor_r(2), Inertias.exo.COMs.knee_motor_r(1) Inertias.exo.COMs.knee_motor_r(3)]);
...
knee_rotation_trans_COM_sup_shank_cuff = makehgtform('zrotate', Q_act.(['H3_knee_angle_r'])(i), 'translate', [knee_motor_COM_sup_shank_cuff_offset(1), knee_motor_COM_sup_shank_cuff_offset(2) knee_motor_COM_sup_shank_cuff_offset(3)]);
...
ankle_trans_COM_ankle_motor = makehgtform('zrotate', Q_act.(['H3_ankle_angle_r'])(i),'translate', [-Inertias.exo.COMs.ankle_motor_r(2), Inertias.exo.COMs.ankle_motor_r(1) Inertias.exo.COMs.ankle_motor_r(3)]);
...
%% Left Exo Leg
hip_flexion = makehgtform('zrotate', (Q_act.(['H3_hip_flexion_l'])(i)), 'xrotate', pi/2);
hip_adduction = makehgtform('zrotate', (Q_act.(['H3_hip_adduction_l'])(i)-pi/2), 'xrotate', -pi/2); %hip adduction
hip_rotation_hk_transf = makehgtform('zrotate', (Q_act.(['H3_hip_rotation_l'])(i)-pi/2),'translate', [0 0 -Lengths.exo.thigh_l], 'xrotate', pi/2); %hip rotation
...
hip_rotation_trans_COM_h = makehgtform('zrotate', Q_act.(['H3_hip_rotation_l'])(i), 'translate', [-Inertias.exo.COMs.(['H3_thigh_l'])(3)-hip_motor_trans_thigh(3) -Inertias.exo.COMs.(['H3_thigh_l'])(1)-hip_motor_trans_thigh(1) Inertias.exo.COMs.(['H3_thigh_l'])(2)+hip_motor_trans_thigh(2)]);
T0_COM_thigh = T02*hip_rotation_trans_COM_h;
Transformations.exo.left.hip_to_COM_thigh=T0_COM_thigh;

hip_rotation_trans_COM_hip_motor = makehgtform('zrotate', Q_act.(['H3_hip_rotation_l'])(i), 'translate', [-Inertias.exo.COMs.(['hip_motor_l'])(3) -Inertias.exo.COMs.('hip_motor_l')(1) Inertias.exo.COMs.('hip_motor_l')(2)]);
...
rotz_k_COM_shank = makehgtform('zrotate', (Q_act.(['H3_knee_angle_l'])(i)-(pi/2)), 'translate', [-Inertias.exo.COMs.(['H3_shank_l'])(2)-knee_motor_trans_shank(2) Inertias.exo.COMs.(['H3_shank_l'])(1)+knee_motor_trans_shank(1) Inertias.exo.COMs.(['H3_shank_l'])(3)+knee_motor_trans_shank(3)]); %x pointing down, y pointing forwards, z pointing to the right
T0_COM_shank = T03*rotz_k_COM_shank; 
Transformations.exo.left.hip_to_COM_shank=T0_COM_shank;

rotz_k_trans_ka = makehgtform('zrotate', (Q_act.(['H3_knee_angle_l'])(i)-pi/2),'translate', [Lengths.exo.shank_l,0,0]);
T04 = T03*rotz_k_trans_ka; % x pointing down, y pointing forwards, z pointing to the right
Transformations.exo.left.hip_to_ankle = T04;

rotz_a_toes = makehgtform('zrotate', Q_act.(['H3_ankle_angle_l'])(i),'translate', [-Inertias.exo.COMs.(['H3_foot_l'])(2) Lengths.exo.foot_l Inertias.exo.COMs.(['H3_foot_l'])(3)]);
T0_toes = T04 * rotz_a_toes;
...
rotz_a_COM_a = makehgtform('zrotate', Q_act.(['H3_ankle_angle_l'])(i),'translate', [-Inertias.exo.COMs.(['H3_foot_l'])(2)-ankle_motor_trans_foot(2) Inertias.exo.COMs.(['H3_foot_l'])(1)+ankle_motor_trans_foot(1) Inertias.exo.COMs.(['H3_foot_l'])(3)+ankle_motor_trans_foot(3)]);
T0_COM_a = T04 * rotz_a_COM_a;
...
hip_rotation_trans_COM_sup_thigh_cuff = makehgtform('zrotate', Q_act.(['H3_hip_rotation_l'])(i), 'translate', [-hip_motor_COM_sup_thigh_cuff_offset(3) -hip_motor_COM_sup_thigh_cuff_offset(1) hip_motor_COM_sup_thigh_cuff_offset(2)]);
T0_COM_sup_thigh_cuff = T02 * hip_rotation_trans_COM_sup_thigh_cuff;
...
knee_trans_COM_knee_motor = makehgtform('zrotate', (Q_act.(['H3_knee_angle_l'])(i)-pi/2),'translate', [-Inertias.exo.COMs.knee_motor_l(2), Inertias.exo.COMs.knee_motor_l(1) Inertias.exo.COMs.knee_motor_l(3)]);
T0_COM_knee_motor = T03 * knee_trans_COM_knee_motor;
...
knee_rotation_trans_COM_sup_shank_cuff = makehgtform('zrotate', Q_act.(['H3_knee_angle_l'])(i), 'translate', [knee_motor_COM_sup_shank_cuff_offset(1), knee_motor_COM_sup_shank_cuff_offset(2) knee_motor_COM_sup_shank_cuff_offset(3)]);
T0_COM_sup_shank_cuff = T03 * knee_rotation_trans_COM_sup_shank_cuff;
...
ankle_trans_COM_ankle_motor = makehgtform('zrotate', Q_act.(['H3_ankle_angle_l'])(i),'translate', [-Inertias.exo.COMs.ankle_motor_l(2), Inertias.exo.COMs.ankle_motor_l(1) Inertias.exo.COMs.ankle_motor_l(3)]);
T0_COM_ankle_motor = T04 * ankle_trans_COM_ankle_motor;
